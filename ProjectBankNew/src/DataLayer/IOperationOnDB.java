...
public interface IOperationOnDB {
	...
	public HashMap<String,Object> getAccountDetails(int accNo);
	...
	public boolean customer_Login_Credentials(String userName);
	public boolean customer_Login_Credentials(String userName,String password);
	public boolean emp_Login_Credentials(String userName,String password);
